(function () {
    ...
    UM.registerWidget(widgetName, {
        ...
        tpl: "<style type=\"text/css\">" +
            ".edui-dialog-map .edui-map-content{width:530px; height: 250px;margin: 10px auto;}" +
            ...
            "</tr>" +
            "</table>" +
            "<div style=\"width:100%;height:240px;margin:5px auto;border:1px solid gray\" class=\"edui-map-container\"></div>" +
            "</div>" +
